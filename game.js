...
function Character() {
 ...
 this.update = function () {
  if (keyboard.getPressed() == ' ') {
   this.image.src = "Imagenes/vox.png";
...
function Kamehameha() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/españa.jpg";
...
function Minicell() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/ricardo.jpg";
...
function Shot() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/tenor.gif";
...
var winbox = new Image(); winbox.src = "Imagenes/win.jpg";
